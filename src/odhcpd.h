...
// Function declarations for fuzzing
void handle_dump(struct ubus_request *req, int type, struct blob_attr *msg);
void handle_icmpv6(void *addr, void *data, size_t len, struct interface *iface, void *dest);
void handle_solicit(void *addr, void *data, size_t len, struct interface *iface, void *dest);
